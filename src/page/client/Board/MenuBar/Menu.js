        ...
        <MenuDiv>
            ...
            <MenuForm>
                ...
                <MenuSubForm>
                    ...
                    <MenuSubGroup>
                        <MenuRow onClick={() => {navigate("/board/aa")}}>
                            <img src={Account}></img>
                            <div>모모 게시판</div>
                        </MenuRow>

                        <MenuRow onClick={() => {navigate("/board/bb")}}>
                            <img src={Account}></img>
                            <div>덕질 게시판</div>
                        </MenuRow>

                        <MenuRow onClick={() => {navigate("/board/cc")}}>
                            <img src={Account}></img>
                            <div>자유 게시판</div>
                        </MenuRow>

                        <MenuRow onClick={() => {navigate("/board/dd")}}>
                            <img src={Account}></img>
                            <div>문어 게시판</div>
                        </MenuRow>

                        <MenuRow onClick={() => {navigate("/board/ee")}}>
                            <img src={Account}></img>
                            <div>응애 게시판</div>
                        </MenuRow>

                        <MenuRow onClick={() => {navigate("/board/ff")}}>
                            <img src={Account}></img>
                            <div>개발 게시판</div>
                        </MenuRow>
                    </MenuSubGroup>
