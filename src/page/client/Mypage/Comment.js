...
import { CommendRecord, CommendRecordBox, CommentWrap, ContentsInner, DeleteBtn } from "./css/Comment";
import  profile_base from "../../../images/profile_base.png";
const App = () => {
    return (
        <>
            <CommentWrap>
                <span>전체 댓글 <span className="count">3</span></span>
                <ContentsInner>
                    <input type="checkbox" />
                ...
                <ContentsInner>
                    ...
                    <CommendRecordBox>
                        <div className="title">
                            <span className="title_info">[덕질] 미라지콘 동행 있는 사람?</span>
